...
android { namespace = "com.idsanna.android"; compileSdk = 35
    defaultConfig { applicationId = "com.idsanna.android"; minSdk = 26; targetSdk = 35; versionCode = 1; versionName = "0.1.0" }
